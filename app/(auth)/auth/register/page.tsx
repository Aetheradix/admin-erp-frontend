    ...
    <div className="auth-form-container">
      ...
      >
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          <Form.Item
            label={<span style={{ fontWeight: 600, fontSize: 13 }}>First Name <span style={{ color: 'var(--primary)' }}>*</span></span>}
            name="firstName"
          ...
          <Form.Item
            label={<span style={{ fontWeight: 600, fontSize: 13 }}>Last Name <span style={{ color: 'var(--primary)' }}>*</span></span>}
            name="lastName"
            rules={[{ required: true, message: 'Required' }]}
          >
            <Input
        ...
        <Form.Item
          label={<span style={{ fontWeight: 600, fontSize: 13 }}>Confirm Password <span style={{ color: 'var(--primary)' }}>*</span></span>}
