...
export default function GeneralSettingsPage() {
  return (
    <div>
      ...
      <Row gutter={[20, 20]}>
        <Col xs={24} lg={16}>
          <Card title="Application" style={{ borderRadius: 16, border: '1px solid var(--border-subtle)', marginBottom: 20 }}>
            <Form layout="vertical" requiredMark={false} initialValues={{ appName: 'AetherERP', language: 'en', timezone: 'America/Los_Angeles', dateFormat: 'MM/DD/YYYY', currency: 'USD' }}>
              <Row gutter={16}>
          ...
          <Card title="Notifications" style={{ borderRadius: 16, border: '1px solid var(--border-subtle)' }}>
