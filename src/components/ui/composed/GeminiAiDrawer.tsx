...
const QUICK_PROMPTS = [
    ...
    },
    {
        ...
        prompt: 'How can I efficiently structure task management and team assignments in the Tasks module?',
    },
    {
        icon: CreditCard,
    ...
    },
    {
        ...
        prompt: 'How do I customize accent colors, dark mode, display density, and session timeouts in Settings?',
    },
];
...
export const GeminiAiDrawer: React.FC<GeminiAiDrawerProps> = ({ visible, onClose }) => {
    ...
    const handleSend = async (customPrompt?: string) => {
        ...
        try {
            ...
            const errText = err?.message || 'Failed to communicate with Gemini API. Please check your API key and connection.';
                        ...
                        <div className="p-5 border-b border-border-subtle flex items-center justify-between bg-surface-subtle/50">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className={`p-2 rounded-lg transition-colors cursor-pointer ${showKeyInput
                        ...
                        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-4 bg-surface-subtle/30">
                            {messages.map((msg) => (
                                ...
                                >
                                    {/* Avatar */}
                                    <div
                                        className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 text-white font-bold text-xs ${msg.sender === 'user'
