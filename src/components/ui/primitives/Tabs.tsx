      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={cn(
              'relative px-8 py-3.5 rounded-2xl text-[10px] font-black tracking-[0.2em] uppercase transition-all duration-300 flex-shrink-0 border-none cursor-pointer flex items-center justify-center gap-2 outline-none focus-visible:ring-2 focus-visible:ring-primary/40 overflow-hidden',
              isActive
