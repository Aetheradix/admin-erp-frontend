...
export const mockCareers: import('@/types/models').Career[] = [
  {
    ...
    type: 'Full-time',
    salary: '$140k - $180k',
    description: 'We are looking for a visionary Frontend Engineer to help us build the next generation of ERP systems with React and TypeScript.',
    requirements: [
  ...
  },
  {
    ...
    type: 'Full-time',
    salary: '$120k - $160k',
    description: 'Join our design team to create beautiful, intuitive interfaces for enterprise users.',
    requirements: [
