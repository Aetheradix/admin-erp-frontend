                ...
                {stats.map((stat, i) => (
                    ...
                    >
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className={`flex items-center gap-1 text-xs font-black ${stat.trend === 'up' ? 'text-success' : 'text-error'}`}>
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs font-bold text-muted uppercase tracking-[0.1em]">{stat.label}</span>
                        </div>
                    </motion.div>
                ))}
            </div>
