      ...
      <div className="p-10 rounded-4xl bg-foreground text-white flex flex-col gap-6 relative overflow-hidden group">
        ...
        <div className="relative z-10 flex flex-col gap-4 max-w-2xl">
          <h2 className="text-3xl font-black leading-tight">
            Digital Signature <span className="text-primary">Required</span>
          </h2>
          <p className="text-muted-foreground text-lg font-medium leading-relaxed">
            Every employee is required to acknowledge the latest updates to the Code of Conduct and
