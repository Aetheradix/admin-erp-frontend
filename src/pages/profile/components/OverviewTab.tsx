        ...
        <div className="flex flex-col gap-8 animate-in fade-in duration-300">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-surface-subtle/50 p-6 rounded-2xl border border-border-subtle flex flex-col gap-4">
                    <h4 className="text-xs font-black text-foreground uppercase tracking-wider">Quick Overview</h4>
                    ...
                    {user.manager ? (
                        <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-border-subtle">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-[10px] font-extrabold text-primary uppercase mt-0.5">{user.manager.code}</span>
                            </div>
                        </div>
                    ) : (
