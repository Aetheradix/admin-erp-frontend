                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <p className="text-sm font-semibold text-muted">{user.designation} • {user.department}</p>
                ...
                <div className="flex items-center gap-8 mt-8 border-t border-border-subtle/60 pt-4 -mb-4 overflow-x-auto no-scrollbar">
                    {(['overview', 'profile', 'organization'] as TabType[]).map((tab) => (
                        <button
                            ...
                            className={`pb-3 text-sm font-extrabold capitalize tracking-wide transition-all relative cursor-pointer ${activeTab === tab
                                    ? 'text-primary'
