...
export const mockBlogs: import('@/types/models').Blog[] = [
  {
    ...
    excerpt:
      'Discover how AI and automation are reshaping the enterprise resource planning landscape.',
    content:
      '<p>Enterprise Resource Planning (ERP) systems have come a long way since their inception. In 2026, we are seeing a massive shift towards <strong>Autonomous ERP</strong>...</p>',
    author: {
      name: 'Sarah Chen',
  ...
  },
  {
    ...
    content:
      '<p>Managing a remote team requires more than just Zoom calls. It requires building a culture of trust and clear communication...</p>',
    author: {
      name: 'Marcus Bell',
  ...
  },
  {
    ...
    content:
      '<p>Growth is the goal of every startup, but scaling sustainably is the real challenge...</p>',
    author: {
