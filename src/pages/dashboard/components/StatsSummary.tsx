    ...
    <div className="flex flex-col gap-6">
        ...
        >
          ...
          <div className="mt-6 h-1 w-full bg-surface-subtle rounded-full overflow-hidden">
            <motion.div
              initial={{ width: 0 }}
              animate={{
                width: card.isPositive
                  ? `${Math.min(100, Math.max(10, Number(completionPercent)))}%`
                  : '45%',
              }}
      ...
      >
        ...
        <div className="relative">
          ...
          <p className="text-xs font-medium text-white/60 mb-6">
            {completionPercent}% Average Completion
          </p>
