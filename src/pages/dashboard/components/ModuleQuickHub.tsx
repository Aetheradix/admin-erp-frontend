...
interface ModuleQuickHubProps {
    liveCounts: LiveCounts;
    stats: Stats;
}

export const ModuleQuickHub: React.FC<ModuleQuickHubProps> = ({ liveCounts, stats }) => {
    ...
    const moduleCards = [
        ...
        },
        {
            ...
            value: `₹ ${Number(liveCounts.reimbursements * 12500 + 45000).toLocaleString('en-IN')}`,
