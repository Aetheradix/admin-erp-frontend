...
import { Filter, Calendar as CalendarIcon, Tag, UserCheck, Building2, RotateCcw } from 'lucide-react';
                ...
                {categories.length > 0 && (
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex flex-wrap gap-2">
                            <button
                                type="button"
                                className={`px-4 py-2 rounded-2xl font-black text-xs transition-all border ${!filters.category || filters.category === 'All'
                            ...
                            {categories.map((cat) => (
                                <button
                                    key={cat}
                                    type="button"
                                    className={`px-4 py-2 rounded-2xl font-bold text-xs transition-all border ${filters.category === cat
                            ...
                            {employeeStatuses.map((st) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`px-3 py-1.5 rounded-2xl text-xs font-black tracking-wide border transition-all ${isSelected
                            ...
                            {tags.map((t) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-xl text-[11px] font-bold border transition-all ${isSelected
                            ...
                            {departments.map((dept) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`px-3.5 py-1.5 rounded-2xl text-xs font-bold border transition-all ${isSelected
