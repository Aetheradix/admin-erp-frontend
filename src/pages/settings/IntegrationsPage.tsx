...
export function IntegrationsPage() {
    ...
    const [activeItems, setActiveItems] = useState<Record<number, boolean>>(() => {
        const base = integrations.reduce<Record<number, boolean>>((acc, item) => ({ ...acc, [item.id]: item.connected }), {});
        ...
        <div className="flex flex-col gap-10 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            >
                <div className="flex flex-col gap-5">
                    <div className="flex flex-col gap-2">
                        <label className="text-[10px] font-extrabold text-muted uppercase tracking-[0.2em]">Jira Site URL</label>
                        <Input
                        ...
                        />
                        <span className="text-[10px] text-muted italic">Enterprise cloud URL of your Atlassian workspace.</span>
                    </div>

                    <div className="flex flex-col gap-2">
                        <label className="text-[10px] font-extrabold text-muted uppercase tracking-[0.2em]">Jira Account Email</label>
                        <Input
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="text-[10px] font-extrabold text-muted uppercase tracking-[0.2em]">Jira API Token</label>
                        <Input
                            type="password"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="flex flex-col gap-2">
                            <label className="text-[10px] font-extrabold text-muted uppercase tracking-[0.2em]">Project Key</label>
                            <Input
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-[10px] font-extrabold text-muted uppercase tracking-[0.2em]">Default Issue Type</label>
                            <Input
                    ...
                    <div className="flex items-center justify-between p-4 rounded-xl bg-surface-subtle border border-border-subtle mt-2">
                        <div className="flex flex-col gap-0.5">
                            ...
                            <span className="text-[10px] text-muted italic">Bypasses strict web browser CORS blocking rules automatically.</span>
                        </div>
                        <InputSwitch
