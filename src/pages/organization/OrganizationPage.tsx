...
const companyInfo = {
  ...
  description:
    'Aetheradix Technologies is a leading provider of enterprise resource planning solutions, helping businesses streamline operations through intelligent automation and data-driven insights.',
  ...
  return (
    <div className="flex flex-col gap-10 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <PageHeader
        ...
        breadcrumbs={[{ label: 'Home', url: '/' }, { label: 'Organization' }]}
      />
