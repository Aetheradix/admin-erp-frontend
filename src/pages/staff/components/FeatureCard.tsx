      ...
      <div className="flex items-start justify-between mb-8">
        <div className="flex items-center gap-5">
          ...
          <div className="flex flex-col">
            <h3 className="text-xl font-black text-foreground tracking-tight leading-none uppercase">
              {feature.id}
            </h3>
            <span className="text-[10px] text-muted font-black uppercase tracking-widest mt-2">
              Module Permissions
            </span>
          </div>
        </div>
