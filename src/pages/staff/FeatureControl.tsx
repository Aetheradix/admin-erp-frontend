...
const FEATURES = [
  {
    id: 'Finance',
    icon: CreditCard,
    description: 'Payroll, reimbursements and financial reporting.',
    color: 'emerald',
  },
  {
    id: 'Attendance',
    icon: Calendar,
    description: 'Clock-in/out and overall attendance tracking.',
    color: 'blue',
  },
  {
    id: 'Blogs',
    icon: Layout,
    description: 'Company-wide internal knowledge base and posts.',
    color: 'purple',
  },
  {
    id: 'Gallery',
    icon: Layout,
    description: 'Media asset repository and event albums.',
    color: 'pink',
  },
  {
    id: 'Events',
    icon: Calendar,
    description: 'Manage and display upcoming company events.',
    color: 'amber',
  },
  {
    id: 'Careers',
    icon: Users,
    description: 'Job postings and internal talent acquisition.',
    color: 'indigo',
  },
  {
    id: 'Grievances',
    icon: AlertCircle,
    description: 'Internal support system and conflict resolution.',
    color: 'rose',
  },
  {
    id: 'Guest Pass',
    icon: Key,
    description: 'Visitor management and access authorizations.',
    color: 'blue',
  },
  {
    id: 'Approvals',
    icon: CheckCircle2,
    description: 'Personnel request processing and workflow control.',
    color: 'green',
  },
];
    ...
    <div className="flex flex-col gap-14 pb-32 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      ...
      <div className="mt-10 p-10 bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl border border-primary/10 flex flex-col md:flex-row items-center gap-8 shadow-inner shadow-primary/5">
        ...
        <div className="flex flex-col gap-2 text-center md:text-left">
          <h4 className="text-lg font-black text-primary uppercase tracking-widest">
            Administrative Policy Control
          </h4>
          <p className="text-xs font-bold text-muted/80 leading-relaxed italic max-w-3xl">
            This module represents the highest tier of system intelligence. Adjusting these toggles
            will instantly recalibrate the digital experience for corresponding departments,
            affecting navigation, routing, and operational accessibility in real-time.
          </p>
        </div>
      </div>
    </div>
